...
class DossierRepository extends EntityRepository
{
    ...
    {
    	$repository = $this->getEntityManager()->getRepository('SiplecCdBundle:Dossier');
    ...
    {
    	$results = array();
    	$statutRefusAuto = $this->getEntityManager()->getRepository('SiplecCdBundle:StatutDossier')->find(Dossier::STATUT_REFUS_AUTOMATIQUE_EN_COURS);
    ...
    public function getLastDossierByTypeCourrierAndNumDossier($numDossier, $typeCourrier){
    	...
    	$dossiers = $this->getEntityManager()->getRepository('SiplecCdBundle:Dossier')
    ...
    {
		return $this->getEntityManager()->getRepository('SiplecCdBundle:Dossier')
			->createQueryBuilder('d')
			->update()
